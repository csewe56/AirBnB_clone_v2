#!/usr/bin/python3
'''This is the console for the module'''
import cmd
import sys
...
class HBNBCommand(cmd.Cmd):
    ''' Embeddd with utilities for the console functionality'''

    # This evalutes the various mode of operation 
    # That is interactive and non interactive mode
    ...
    def preloop(self):
    '''Display to the console if isatty is false'''
    ...
    def precmd(self, line):
        ...
        '''
        _cmd = _cls = _id = _args = ""  # set to work line elements
        ...
        for i, att_name in enumerate(args):
            ...
            if i % 2 == 0:
                ...
                if not att_name:  # check for att_name
                    ...
                    return
                if not att_val:  # verify for attribute value
                    print("** value missing **")
                    return
